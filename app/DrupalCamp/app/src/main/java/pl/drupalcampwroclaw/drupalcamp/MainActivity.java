...
import pl.drupalcampwroclaw.drupalcamp.json.ConnectionDetector;
import pl.drupalcampwroclaw.drupalcamp.json.JSONParser;
import pl.drupalcampwroclaw.drupalcamp.others.ErrorMessage;
import pl.drupalcampwroclaw.drupalcamp.sessions.Session;
import pl.drupalcampwroclaw.drupalcamp.sessions.SessionAdapter;
import pl.drupalcampwroclaw.drupalcamp.others.SharedPreference;
...
public class MainActivity extends ActionBarActivity {
    ...
    private void onLoadSessions() {
        ...
        lView_saturday.setAdapter(sessions_list.get(0));
        lView_sunday.setAdapter(sessions_list.get(1));
    ...
    private void onCreateTabs() {
        ...
        TabHost.TabSpec tabSpec = tabHost.newTabSpec("session_saturday");
